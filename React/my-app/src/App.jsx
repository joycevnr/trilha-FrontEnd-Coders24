...
class App extends React.Component{
  ...
  render(){
    return (//não povo retornar no método render duas tags, só pode retornar uma tag, por isso que tudo tem que colocar dentro de um fragment <></> ou div
      <>
        <header>
          <Navbar/>
        </header>
        <main>
          <section id="articles">
             <Article title="É Assim que Acaba" provider="Colleen Hoover" description=" É assim que acaba é o romance mais pessoal da carreira de Colleen Hoover, discutindo temas como violência doméstica e abuso psicológico de forma sensível e direta. " thumbnall={AssimQueAcaba}/>

             <Article title="O Pequeno Príncipe" provider="Antoine de Saint-Exupéry" description="Nesta história que marcou gerações de leitores em todo o mundo, um piloto cai com seu avião no deserto do Saara e encontra um pequeno príncipe, que o leva a uma aventura filosófica e poética através de planetas que encerram a solidão humana."
             thumbnall={Principe}/>
