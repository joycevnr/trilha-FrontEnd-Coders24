...
ReactDOM.render(
  <React.StrictMode>{/*ferramenta para chegar possíveis más práticas no código react, caso encontre potênciais problemas, emite warnings -(apenas no ambiente de desenvolvimento)- roda duas vezes oq pode até ajudar a capturar bugs*/}
